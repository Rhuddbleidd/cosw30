...
<body>
    <header>
        <ul>
            <li><a href="homework/add_order.php">Add Orders Page</a></li>
            <li><a href="homework/add_product.php">Add Product Page</a></li>
            <li><a href="homework/add_user.php">Add New Users Page</a></li>
            <li><a href="homework/list_orders.php">List Of Orders</a></li>
            <li><a href="homework/list_users.php">Users List</a></li>
            <li><a href="homework/list_products.php">Product List</a></li>
        </ul>
    </header>
    <main>
        <section>
